...
async function Execute(scriptPath, options = {}) {
  ...
  try {
    ...
    const value = data.value !== void 0 ? data.value : extractJsonValue(data.stdout || "");
    return {
...
function getValue(result, path, defaultValue) {
